...
(defmacro tk-macro
  ...
  [draw Canvas Shape Coordinates | Options]
                                -> (if (element? -tag Options)
                                        [my-draw Canvas Shape Coordinates (shen.cons-form Options)]
                                        [my-draw Canvas Shape Coordinates
                                                    (shen.cons-form [-tag (gensym shape) | Options])])
