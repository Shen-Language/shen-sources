(let RCC (rcc-axioms)
     ...
     [RCC Theorem (initialise-plan)
      ...
      (thorn.timeout 20)
      (lemma Lemma1 "If x partially overlaps y and y is a non-tangential proper part of z, then z is not part of x.")
      (thorn.timeout 5)
      ...
      (lemma Lemma7 "From po(x,y) and ntpp(y,z), x is connected to z.")
      ...
      (thorn.timeout 20)
      (lemma Lemma9 "The ec(x,z) branch is impossible under po(x,y) and ntpp(y,z).")
      (thorn.timeout 5)
