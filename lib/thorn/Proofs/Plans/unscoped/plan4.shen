(time (let* RCC (rcc-axioms)
     ...
     [RCC Theorem (initialise-plan)
      ...
      (lemma Lemma6 "If x is disconnected from y and y is a non-tangential proper part of z, then z is not part of x.")
      ...
      (lemma Theorem "Combine the same local case splits as before.")
      (end-of-plan)]))