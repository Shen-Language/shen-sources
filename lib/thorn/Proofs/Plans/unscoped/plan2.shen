(time (let* RCC (rcc-axioms)
     ...
     Lemma6  [all x [all y [all z [[[dc x y] & [po y z]] => [[dc x z] v [c x z]]]]]] 
     Lemma7  [all x [all y [all z [[[[dc x y] & [po y z]] & [c x z]]
                                   => [[ec x z] v [o x z]]]]]]
     Lemma8  [all x [all y [all z [[[[[dc x y] & [po y z]] & [c x z]] & [o x z]]
                                   => [[po x z] v [pp x z]]]]]]
     Lemma9  [all x [all y [[pp x y] => [[tpp x y] v [ntpp x y]]]]]
     Lemma10 [all x [all y [all z [[[[[dc x y] & [po y z]] & [c x z]] & [o x z]]
                                   => [[po x z] v [[tpp x z] v [ntpp x z]]]]]]]

     [RCC Theorem (initialise-plan)
      (kb-> RCC)

      (lemma Lemma1 "Proper part implies parthood.")
      (kb-> [Lemma1 | RCC])

      (lemma Lemma2 "Tangential proper part implies proper part.")
      (kb-> [Lemma2 Lemma1 | RCC])

      (lemma Lemma3 "Non-tangential proper part implies proper part.")
      (kb-> [Lemma3 Lemma2 Lemma1 | RCC])

      (lemma Lemma4 "Parthood lifts connection from part to whole.")
      (kb-> [Lemma4 Lemma3 Lemma2 Lemma1 | RCC])

      (lemma Lemma5 "If x is disconnected from y and y partially overlaps z, then z is not part of x.")
      (kb-> [Lemma5 Lemma4 Lemma3 Lemma2 Lemma1 | RCC])

      (lemma Lemma6 "Case split on whether x is connected to z; if not, then dc x z.")
      (kb-> [Lemma6 Lemma5 Lemma4 Lemma3 Lemma2 Lemma1 | RCC])

      (lemma Lemma7 "If x is connected to z, split on overlap to get ec x z or o x z.")
      (kb-> [Lemma7 Lemma6 Lemma5 Lemma4 Lemma3 Lemma2 Lemma1 | RCC])

      (lemma Lemma8 "If x overlaps z and z is not part of x, then either po x z or pp x z.")
      (kb-> [Lemma8 Lemma7 Lemma6 Lemma5 Lemma4 Lemma3 Lemma2 Lemma1 | RCC])

      (lemma Lemma9 "Proper part decomposes into tangential or non-tangential proper part.")
      (kb-> [Lemma9 Lemma8 Lemma7 Lemma6 Lemma5 Lemma4 Lemma3 Lemma2 Lemma1 | RCC])

      (lemma Lemma10 "Refine the overlap case from po or pp to po or tpp or ntpp.")
