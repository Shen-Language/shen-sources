...
(define tarski
  ...
  -> (kb-> [
                \\1
                [all a [all b [[between a b a] => [eq a b]]]]
               ...
               [all a [all b [equi a b b a]]]
                ...
                \\4                
                [all a [all b [all c [[equi a b c c] => [eq a b]]]]]
                ...
                & [between a* b* c*]]] & [~ [eq a b]]] => [equi c d c* d*]]]]]]]]]] 
                ...
                [all a [all p [all q [all b [all c 
                  [[[[equi a p a q] & [equi b p b q]] & [[equi c p c q] & [~ [eq p q]]]] 
...
(<-kb [all x [all y [between x x y]]]) \\ no
(<-kb [all x [all y [all z [[between x y z] => [between x z y]]]]]) \\no
